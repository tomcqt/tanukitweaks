...
import { domain, tanukiver, source_url, statusPageUrl, profile_directory as profileDirectory } from 'mastodon/initial_state';
    ...
    return (
      <div className='link-footer'>
        <p>
          ...
          {DividingCircle}
          <span className='version'>v{tanukiver}</span>
        </p>
